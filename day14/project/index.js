...
images.forEach((img)=>{
     ...
     thumbnails.classList.add("Thumbnails-item");
     thumbnails.innerHTML=`
     <img src='${img.img}?${THUMBNAIL_PARAMS}' class="img">`;
     thumbnails .addEventListener("Click",(e)=>handleSelection(e,img));
